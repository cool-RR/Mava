...
def main(_: Any) -> None:
    ...
    system.build(
        ...
        num_simulations_scheduler = optax.piecewise_constant_schedule(init_value=20,boundaries_and_scales={50_000 : 1.5, 100_000 : 1.5, 150_000 : 1.5, 200_000 : 1.5, 300_000 : 1.5}),
        evaluator_num_simulations_scheduler = optax.piecewise_constant_schedule(init_value=40,boundaries_and_scales={50_000 : 1.5, 100_000 : 1.5, 150_000 : 1.5, 200_000 : 1.5, 300_000 : 1.5}),
